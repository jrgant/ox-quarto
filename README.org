...
The package is in the early stages of development, and help from folks with more =elisp= than I have is most welcome. (I am a beginner, now using AI to help me out with this.) Please report bugs and enhancement requests in the [[https://github.com/jrgant/ox-quarto/issues][Issues]].
